...
<!-- 게시판 목록 시작 { -->
    ...
    <div>
        <label class="checkbox">
			...
			<i></i><span class="lbl">현재 페이지 게시물 전체 선택</span>
		</label>
    </div>
    <?php } ?>

    <ul class="gall_list gall_row">
            ...
            <div class="gall_box">
                ...
                <?php if ($is_checkbox) { ?>
					<label class="checkbox">
						...
						<i></i><span class="lbl blind">선택</span>
					</label>
                <?php } ?>
					...
					<div class="gall_con">
						<div class="gall_text_href">
							<div>
							 ...
							 <p class="gall_date"><span class="sound_only">작성일 </span><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo $list[$i]['datetime'] ?></p>
						</div>
					</div>
					</a>
				</div>
				<div class="gall_info">
					<span class="gall_name">
