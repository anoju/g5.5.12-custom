	...
	<ul class="list_view">
		...
		<li class="list_social">
			...
			<div class="list_like">
				...
				<?php if($board['bo_use_nogood']) { ?><span class="ic_txt ic__gray"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i><span>싫어요</span><strong><?php echo number_format($view['wr_nogood']) ?></strong></span><?php } ?>
			</div>
			<?php
				}
			}
