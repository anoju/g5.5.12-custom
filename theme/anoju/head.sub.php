...
<link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL; ?>/common.css?ver=<?php echo G5_CSS_VER; ?>">
...
add_javascript('<script src="'.G5_THEME_JS_URL.'/common/jquery-ui.min.js"></script>', 0);
add_javascript('<script src="'.G5_THEME_JS_URL.'/plugins.js"></script>', 0);
add_javascript('<script src="'.G5_THEME_JS_URL.'/ui_script.js?ver='.G5_JS_VER.'"></script>', 0);
