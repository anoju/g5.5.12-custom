...
<div class="reg_result">
    ...
    <p>
        ...
        발송된 인증메일을 확인하신 후 인증 및 관리자 승인 후 사이트를 이용하실 수 있습니다.
    </p>
    <div class="result_email">
        <span>아이디</span>
...
<!-- } 회원가입결과 끝 -->
<div class="btn_wrap">
	<a href="<?php echo G5_URL ?>/" class="button h60 w-150 btn_blue">메인으로</a>
</div>