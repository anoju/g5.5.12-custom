...
<!-- 로그인 후 아웃로그인 시작 { -->
<section class="member-box after">
    <div class="member-after-box">
        <header class="after-hd">
        ...
        <ul class="after-private">
            <li>
                <a href="<?php echo G5_BBS_URL ?>/point.php" target="_blank" id="ol_after-pt" class="win_point">
                    포인트<br>
                    <strong><i class="fa fa-database" aria-hidden="true"></i><?php echo $point; ?></strong>
                </a>
            </li>
            <li>
                <a href="<?php echo G5_BBS_URL ?>/memo.php" target="_blank" id="ol_after-memo" class="win_memo">
