...
<nav class="tag-menu swiper">
    <div class="swiper-wrapper">
    <div class="swiper-slide">
        <button type="button" class="tag-item on" data-value="all">ALL</button>
    </div>
    <div class="swiper-slide">
        <button type="button" class="tag-item" data-value="bank">Bank</button>
    </div>
    <div class="swiper-slide">
        <button type="button" class="tag-item" data-value="insurance">Insurance</button>
    </div>
    <div class="swiper-slide">
        <button type="button" class="tag-item" data-value="mydata">Mydata</button>
    </div>
    <div class="swiper-slide">
        <button type="button" class="tag-item" data-value="card">Card</button>
    </div>
    <div class="swiper-slide">
        <button type="button" class="tag-item" data-value="ai">AI</button>
    </div>
    <div class="swiper-slide">
        <button type="button" class="tag-item" data-value="vui">VUI</button>
    </div>
    </div>
</nav>
...
<div class="work-wrap">
    ...
    <div class="list-none" style="display:none">선택 태그의 게시물이 없습니다.</div>
    <div class="grid" id="listWrap">
        <?php
        for ($i=0; $i<count($list); $i++) {
        ?>
        <div class="grid-item <?php echo $list[$i]['wr_4'] ?>">
            <a href="<?php echo $list[$i]['href'] ?>" class="work-item">
            ...
            if($thumb['src']) {
                ...
                $img_content = '<img src="'.G5_THEME_IMG_URL.'/favicon/icon-512x512.png" class="no-img" alt="">';
            }
            echo $img_content;
            ?>
            </a>
