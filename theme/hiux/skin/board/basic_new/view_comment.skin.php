...
<!-- 댓글 시작 { -->
<section id="V_COMMENT">
	<div class="ItemTitle">
		<span class="material-icons-outlined" data-board-wenk="COMMENT LIST" data-board-wenk-pos="right">chat_bubble_outline</span>
	</div>
    <?php
    $cmt_amt = count($list);
    for ($i=0; $i<$cmt_amt; $i++) {
	...
	<article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        ...
        <?php if($is_comment_reply_edit) { ?>
		<div class="bo_vl_opt">
            <div class="CommEditButton"><span class="material-icons-outlined">edit_note</span><span class="sound_only">댓글 옵션</span></div>
        	<ul class="bo_vc_act">
    ...
    <div class="bo_vc_w_wr">
        ...
        <div class="btn_confirm">
        	<span class="secret_cm chk_box">
	            <input type="checkbox" name="wr_secret" value="secret" id="wr_secret" class="selec_chk" style="display:none;">
